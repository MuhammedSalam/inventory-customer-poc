...
export class PartitionContext {
    ...
    constructor(context, partitionId, lease) {
        this._offset = EventPosition.startOfStream;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!startingCheckpoint) {
                if (this._context.initialOffset) {
                    log.partitionContext(withHostAndPartiton(this, "User provided initial offset: %s"), this._context.initialOffset.getExpression());
                }
                ...
                log.partitionContext(withHostAndPartiton(this, "Retrieved starting offset/sequence " + "number: %s/%d"), this._offset, this._sequenceNumber);
            }
            log.partitionContext(withHostAndPartiton(this, "Initial position provider offset: %s, " + "sequenceNumber: %d, enqueuedTime: %d"), result.offset, result.sequenceNumber, result.enqueuedTime);
            return result;
        });
    }
    /**
