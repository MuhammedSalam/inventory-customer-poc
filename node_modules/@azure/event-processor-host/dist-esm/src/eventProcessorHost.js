...
import { AadTokenProvider, EventHubClient } from "@azure/event-hubs";
...
export class EventProcessorHost {
    ...
    static createFromAadTokenCredentials(hostName, storageConnectionString, storageContainerName, namespace, eventHubPath, credentials, options) {
        ...
        const connectionString = `Endpoint=sb://${namespace};SharedAccessKeyName=defaultKeyName;` +
            `SharedAccessKey=defaultKeyValue;EntityPath=${eventHubPath}`;
        const ephOptions = Object.assign(Object.assign({}, options), { tokenProvider: new AadTokenProvider(credentials), storageConnectionString: storageConnectionString, storageContainerName: storageContainerName, eventHubPath: eventHubPath, eventHubConnectionString: connectionString });
        return new EventProcessorHost(hostName, ephOptions);
    }
    /**
    ...
    static createFromAadTokenCredentialsWithCustomCheckpointAndLeaseManager(hostName, namespace, eventHubPath, credentials, checkpointManager, leaseManager, options) {
        ...
        const connectionString = `Endpoint=sb://${namespace};SharedAccessKeyName=defaultKeyName;` +
            `SharedAccessKey=defaultKeyValue;EntityPath=${eventHubPath}`;
        const ephOptions = Object.assign(Object.assign({}, options), { tokenProvider: new AadTokenProvider(credentials), eventHubPath: eventHubPath, eventHubConnectionString: connectionString, checkpointManager: checkpointManager, leaseManager: leaseManager });
        return new EventProcessorHost(hostName, ephOptions);
    }
    /**
    ...
    static createFromIotHubConnectionString(hostName, storageConnectionString, storageContainerName, iotHubConnectionString, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            validateType("options", options, false, "object");
            const client = yield EventHubClient.createFromIotHubConnectionString(iotHubConnectionString);
